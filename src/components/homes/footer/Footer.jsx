...
import logo_brand from  '../../../assets/logo.jpg';
...
export const Footer = () => {
  ...
  // Kết quả ra dạng: "22nd May 2026" (Chuẩn Anh) hoặc `${monthName} ${dayNum}${suffix}, ${yearNum}` (Chuẩn Mỹ)
  ...
  return (
    <footer>
      <div className="container grid1">
        <div className="box">
          <img width="95" height="60" src={logo_brand}/>
        ...
        <div className="box">
          ...
          <div className="icon"><i className="fa fa-map-marker-alt" style={{marginRight:'1px'}}></i><span className='locationText'>Location: Hanoi, Vietnam</span></div>
          <div className="icon"><i className="fa fa-phone" style={{marginRight:'1px'}}></i><a href="tel:+84383402036">Phone: +84 383402036</a></div>
          <div className="icon"><i className="fa fa-envelope" style={{marginRight:'1px'}}></i><a href="mailto:dluongta@gmail.com">Email: dluongta@gmail.com</a></div>
        </div>
      </div>
