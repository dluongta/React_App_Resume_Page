  ...
  const data = [
    {
      ...
      para1: "As technology continues to evolve at an unprecedented speed, I want to study, innovate and contribute to solutions that create a significant, beneficial and huge impact on the world.",
    }
  ];
