...
// const CustomMusicPlayer = ({ src, title, artist }) => {
...
//       {/* --- CỤM BÊN TRÁI: ĐĨA NHẠC (CHỮ DLUONGTA) --- */}
//       <div className="record-wrapper">
//         <div className={`record-custom ${isPlaying ? 'playing' : ''}`}>
//           DLUONGTA
//         </div>
//       </div>
...
//         {/* Cụm trên: Thông tin bài hát & Thanh tiến trình */}
//         <div className="player-top">
//           <div className="track-info">
//             <span className="track-title">{title || 'Unknown Title'}</span>
//             {artist && <span className="track-artist"><span style={{ fontSize: '16px' }}>- </span>{artist}</span>}
//           </div>
...
//         {/* Cụm dưới: Nút điều khiển, Âm lượng, Cài đặt */}
...
const CustomMusicPlayer = ({ src, title, artist, useImage = false, cover }) => {
  ...
  const defaultCover = hexagonImg; // Hình ảnh mặc định nếu không có cover được cung cấp
      ...
      {useImage ? (
        <div className="record-image-wrapper">
          <img 
            ...
            alt="vinyl record" 
            className={`record-image ${isPlaying ? 'playing' : ''}`} 
          />
        </div>
      ) : (
        <div className="record-wrapper">
